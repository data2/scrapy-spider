...
class StatsZbHgydSpider(scrapy.Spider):
    name = 'StatsZbHgydSpider'
    ...
    root_zb = ['A01', 'A02', 'A03', 'A04', 'A05', 'A06', 'A07', 'A08', 'A09', 'A0A', 'A0B', 'A0C', 'A0D', 'A0E']
    # root_zb = ['A01']

    root_param ={"dbcode":"hgyd","wdcode":"zb","m":"getTree"}
    ...
    def parse(self, response):
        for id in self.root_zb:
            ...
            self.headers['Referer'] = self.get_tree_url+"?"+urllib.parse.urlencode(self.root_param)
